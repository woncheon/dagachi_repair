...
<%@include file="/WEB-INF/jsp/include/openhead.jsp"%>
	...
	<section class="content-header">
     ...
     <div class="text-center mt-4">
     	...
     	<c:if test="${phoneBook.phone_Book_Type eq '3' }">
	     	<button type="button" class="btn bg-gradient col-sm-2" onclick="recoveryPhoneBook(1);" 
	     	style="background: #5865F2; color:#ffffff;">개인 주소록 복구</button>
	     	
	     	<button type="button" class="btn bg-gradient col-sm-2" onclick="recoveryPhoneBook(2);" 
