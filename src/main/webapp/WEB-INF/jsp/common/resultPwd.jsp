...
<div class="content-wrapper bg-white">
  ...
  <p class="text-blue-600 mt-4">비밀번호 찾기</p>
  </br>
</div>
<div class="card border-success mb-3" style="width:500px;height:500px; margin:0 auto;">
  ...
  <div class="resultid">
	...
	<button onclick="location.href='../common/forget'"type="button" class="btn btn-outline btn-primary btn-sm" style="width:150px; height:40px; margin:0">처음으로</button>
  </div>
  </div>
